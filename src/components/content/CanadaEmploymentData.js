    ...
    return (
        <div className="chart-container">
            ...
            <div className="chart-wrapper">
                ...
                <p>
                    Employment rate is a percentage number of employed to the population 15 years of age and over. Employment includes both full-time and part-time employment. Data type is seasonally adjusted.
                </p>
            </div>
            <div className="chart-wrapper">
                <div className="heading-wrapper">
                ...
                <p>
                    Unemployment rate is a percentage number of unemployed to the population 15 years of age and over. Data type is seasonally adjusted.
                </p>
            </div>
